...
namespace Illuminate\Support\Facades {
     ...
     */        class Response {
         ...
         * @param mixed $status
         * @static 
         */        public static function resource($resource, $status = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::resource($resource, $status);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::created($data);
        }
                    /**
         * 
         *
...
namespace Rakutentech\LaravelRequestDocs {
     ...
     */        class LaravelRequestDocsFacade {
                    /**
         ...
         * @throws \ReflectionException
         * @static 
         */        public static function getDocs($showGet, $showPost, $showPut, $showPatch, $showDelete, $showHead)
        {
                        /** @var \Rakutentech\LaravelRequestDocs\LaravelRequestDocs $instance */
                        return $instance->getDocs($showGet, $showPost, $showPut, $showPatch, $showDelete, $showHead);
        }
                    /**
         ...
         * @return \Illuminate\Support\Collection<int, \Rakutentech\LaravelRequestDocs\Doc> 
         * @static 
         */        public static function splitByMethods($docs)
        {
                        /** @var \Rakutentech\LaravelRequestDocs\LaravelRequestDocs $instance */
                        return $instance->splitByMethods($docs);
        }
                    /**
         * Sort by `$sortBy`.
         *
         ...
         * @return \Illuminate\Support\Collection<int, \Rakutentech\LaravelRequestDocs\Doc> 
         * @static 
         */        public static function sortDocs($docs, $sortBy = 'default')
        {
                        /** @var \Rakutentech\LaravelRequestDocs\LaravelRequestDocs $instance */
                        return $instance->sortDocs($docs, $sortBy);
        }
                    /**
         ...
         * @return \Illuminate\Support\Collection<int, \Rakutentech\LaravelRequestDocs\Doc> 
         * @static 
         */        public static function groupDocs($docs, $groupBy = 'default')
        {
                        /** @var \Rakutentech\LaravelRequestDocs\LaravelRequestDocs $instance */
                        return $instance->groupDocs($docs, $groupBy);
        }
                    /**
         ...
         * @throws \ReflectionException
         * @static 
         */        public static function getControllersInfo($onlyMethods)
        {
                        /** @var \Rakutentech\LaravelRequestDocs\LaravelRequestDocs $instance */
                        return $instance->getControllersInfo($onlyMethods);
        }
                    /**
         ...
         * @throws \ReflectionException
         * @static 
         */        public static function appendRequestRules($docs)
        {
                        /** @var \Rakutentech\LaravelRequestDocs\LaravelRequestDocs $instance */
                        return $instance->appendRequestRules($docs);
        }
                    /**
         ...
         * @return string 
         * @static 
         */        public static function lrdDocComment($docComment)
        {
                        /** @var \Rakutentech\LaravelRequestDocs\LaravelRequestDocs $instance */
                        return $instance->lrdDocComment($docComment);
        }
                    /**
         ...
         * @static 
         */        public static function flattenRules($mixedRules)
        {
                        /** @var \Rakutentech\LaravelRequestDocs\LaravelRequestDocs $instance */
                        return $instance->flattenRules($mixedRules);
        }
                    /**
         ...
         * @throws \ReflectionException
         * @static 
         */        public static function rulesByRegex($requestClassName, $methodName)
        {
                        /** @var \Rakutentech\LaravelRequestDocs\LaravelRequestDocs $instance */
                        return $instance->rulesByRegex($requestClassName, $methodName);
        }
            }
    }
...
namespace  {
            ...
            class LaravelRequestDocs extends \Rakutentech\LaravelRequestDocs\LaravelRequestDocsFacade {}
